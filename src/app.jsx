...
If no meaningful connections exist, return {"connections": []}`,
  ...
  if (isLoading) return (
    <div style={{ height: "100vh", background: C.bg, display: "flex", alignItems: "center", justifyContent: "center" }}>
      <div style={{ color: C.textMuted, fontFamily: sans, fontSize: 21, fontStyle: "italic" }}>Signal</div>
    </div>
  );
    ...
    <div style={{ display: "flex", height: "100vh", background: "#131316", color: C.textPrimary, overflow: "hidden", padding: "8px", gap: 6 }}>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        body { font-family: 'Inter', system-ui, -apple-system, sans-serif; font-size: 12px; line-height: 1.6; -webkit-font-smoothing: antialiased; }
